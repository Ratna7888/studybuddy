...
* Python 3.11+
* Node.js 18+
* Gemini API key from [https://aistudio.google.com/apikey](https://aistudio.google.com/apikey)
...
Open [http://localhost:5173](http://localhost:5173) — backend runs on [http://localhost:8000](http://localhost:8000).
